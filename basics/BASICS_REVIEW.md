# Python Basics Review (by FreeCodeCamp)
...
These are conditions that come after an if statement. If the elif condition evaluates to True, then that block of code will run.
...
The and and or operators are known as a short-circuit operators. Short-circuiting means Python checks values from left to right and stops as soon as it determines the final result.
